...
% Sampul Unit 16 edisi Bahasa Indonesia, diturunkan dari sampul sumber.
...
\begin{tikzpicture}[remember picture, overlay, pencildraw/.style={
	...
	\node[anchor=west] at ([xshift=2.4em] author.east) {\fontsize{10.5}{13}\CJKfamily{cover-author-font}Unit 16: Limit};
