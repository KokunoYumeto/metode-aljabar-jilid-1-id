...
\begin{tikzpicture}[remember picture,overlay]
	...
	\node[anchor=center,align=center,text width=31em] (unit) at ([yshift=-6em] volume.south)
		...
		Bab 5 lengkap\\[0.35em]
		\fontsize{13}{16}\selectfont Pengantar Teori Gelanggang};
	...
	\node[anchor=south,draw=black!30,fill=white,rounded corners=3pt,
		...
		{\sffamily\textbf{Seluruh Bab 5 dalam satu pembaca}\par\smallskip
		Delapan bagian membahas dasar teori gelanggang, gelanggang komutatif dan
		lokalisasi, inversi M\"obius, limit dan pelengkapan, gelanggang polinomial,
		faktorisasi unik, serta polinomial simetris. Penutup memuat 22 latihan
		utama, 31 butir termasuk subbutir, dan 11 petunjuk.\par\smallskip
		\small 8 bagian \textbullet\ 22 latihan \textbullet\ 11 petunjuk\par
		\small teks lengkap Bab 5 \textbullet\ indeks istilah dan simbol};
...
\begin{minipage}[b]{0.82\textwidth}
	...
	dicatat dalam riwayat unit tanpa mengubah maksud matematis. Edisi ini tidak disahkan
