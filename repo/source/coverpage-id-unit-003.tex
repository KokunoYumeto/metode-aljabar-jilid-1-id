...
% Sampul Unit 3 edisi Bahasa Indonesia, diturunkan dari sampul sumber.
...
\begin{tikzpicture}[remember picture, overlay, pencildraw/.style={
	...
	\node[anchor=west] at ([xshift=2.4em] author.east) {\fontsize{12}{15}\CJKfamily{cover-author-font}Unit 3: Struktur Urutan dan Ordinal};
