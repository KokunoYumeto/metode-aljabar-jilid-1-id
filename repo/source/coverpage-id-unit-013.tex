...
% Sampul Unit 13 edisi Bahasa Indonesia, diturunkan dari sampul sumber.
...
\begin{tikzpicture}[remember picture, overlay, pencildraw/.style={
	...
	\node[anchor=west] at ([xshift=2.4em] author.east) {\fontsize{12}{15}\CJKfamily{cover-author-font}Unit 13: Fungtor Representabel dan Lema Yoneda};
