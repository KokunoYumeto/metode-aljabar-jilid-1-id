...
\begin{tikzpicture}[remember picture,overlay]
	...
	\node[anchor=center,align=center,text width=31em] (unit) at ([yshift=-6em] volume.south)
		...
		Bab 6 lengkap\\[0.35em]
		\fontsize{13}{16}\selectfont Modul};
	...
	\node[anchor=south,draw=black!30,fill=white,rounded corners=3pt,
		...
		{\sffamily\textbf{Seluruh Bab 6 dalam satu pembaca}\par\smallskip
		Dua belas bagian membahas modul, modul bebas, hasil kali tensor,
		perubahan gelanggang, eksak kiri dan kanan, modul projektif, injektif,
		dan datar, kondisi Noetherian dan Artinian, modul semisederhana, serta
		modul tak terurai. Penutup memuat 14 latihan utama, 22 butir termasuk
		subbutir, dan 8 petunjuk.\par\smallskip
		\small 12 bagian \textbullet\ 14 latihan \textbullet\ 8 petunjuk\par
		\small teks lengkap Bab 6 \textbullet\ indeks istilah dan simbol};
