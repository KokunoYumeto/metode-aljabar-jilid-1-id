...
% Sampul Unit 2 edisi Bahasa Indonesia, diturunkan dari sampul sumber.
...
\begin{tikzpicture}[remember picture, overlay, pencildraw/.style={
	...
	\node[anchor=west] at ([xshift=2.4em] author.east) {\fontsize{14}{16}\CJKfamily{cover-author-font}Unit 2: Aksioma ZFC};
