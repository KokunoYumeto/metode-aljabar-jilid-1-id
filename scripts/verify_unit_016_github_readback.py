#!/usr/bin/env python3
"""Anonymously verify every path in the immutable Unit 016 GitHub commit."""
...
COMMIT = "a241c6ed66b003decad57b1aeb9e3e266dcd392e"
REPOSITORY = "KokunoYumeto/metode-aljabar-jilid-1-id"
EXPECTED_PARENT = "09cf48562b5c5ab5add7a9102d653757c4f32a3f"
EXPECTED_PATH_COUNT = 60
OUTPUT = ROOT / "qa" / "PUBLICATION_GITHUB_UNIT_016_CONTENT_READBACK.json"
...
def main() -> int:
    ...
    if parent != EXPECTED_PARENT:
        raise RuntimeError(f"unexpected Unit 016 parent: {parent}")
    ...
    for path in paths:
        ...
        digest = sha256(public).hexdigest()
