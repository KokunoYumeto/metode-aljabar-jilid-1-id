#!/usr/bin/env python3
"""Anonymously verify every path in the immutable Unit 019 GitHub commit."""
...
COMMIT = "149adacf2928e8a5497c72d4a069e1b626915ee4"
REPOSITORY = "KokunoYumeto/metode-aljabar-jilid-1-id"
EXPECTED_PARENT = "0b214e2d8967d26cb25023bbee23d39b4e4b2795"
EXPECTED_PATH_COUNT = 53
OUTPUT = ROOT / "qa" / "PUBLICATION_GITHUB_UNIT_019_CONTENT_READBACK.json"
...
def main() -> int:
    ...
    if parent != EXPECTED_PARENT:
        raise RuntimeError(f"unexpected Unit 019 parent: {parent}")
