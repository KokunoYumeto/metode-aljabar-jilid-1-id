#!/usr/bin/env python3
"""Fail-closed anonymous GitHub immutable-byte verifier for Unit 034.
...
USER_AGENT = "O013-unit-034-public-byte-verifier/2.0"
...
Invoke separately, in publication order, while each commit is public main:
  python scripts/verify_unit_034_github_readback.py --boundary content \\
    --expected-commit <40hex> --expected-tree <40hex> \\
    --expected-parent <40hex> --manifest <content-manifest.json>
  python scripts/verify_unit_034_github_readback.py --boundary receipt \\
    --expected-commit <40hex> --expected-tree <40hex> \\
    --expected-parent <40hex> --manifest <receipt-manifest.json>
  python scripts/verify_unit_034_github_readback.py --boundary controls \\
    --expected-commit <40hex> --expected-tree <40hex> \\
...
"""
    parser = argparse.ArgumentParser(
        description="Verify one Unit 034 GitHub publication boundary byte-for-byte.",
        epilog=epilog,
