[CmdletBinding()]
param(
    [string]$OutputDirectory = "build/unit-020-replay"
)
...
$jobName = "unit-020-bab-3-keketatan-dan-teorema-koherensi"
$driverName = "unit-020-bab-3-keketatan-dan-teorema-koherensi.tex"
$xelatexArguments = @(
    "-no-shell-escape",
