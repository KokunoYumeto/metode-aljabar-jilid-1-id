#!/usr/bin/env python3
"""Anonymously verify every path in the immutable Unit 018 GitHub commit."""
...
COMMIT = "861718bf4fc0bf9fe5e02480866987fde9714de4"
REPOSITORY = "KokunoYumeto/metode-aljabar-jilid-1-id"
EXPECTED_PARENT = "a76bd31100b1ec656d8b11e09f842afc19a5633c"
EXPECTED_PATH_COUNT = 38
OUTPUT = ROOT / "qa" / "PUBLICATION_GITHUB_UNIT_018_CONTENT_READBACK.json"
...
def main() -> int:
    ...
    if parent != EXPECTED_PARENT:
        raise RuntimeError(f"unexpected Unit 018 parent: {parent}")
