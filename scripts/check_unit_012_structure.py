...
#!/usr/bin/env python3
"""Fail-closed structural and mathematics-topology gate for O013 Unit 012.
...
def main() -> None:
    ...
    if not next_boundary_ok:
        failures.append("line 678 is no longer the next section boundary")

    report = {
        "schema_version": "unit-012-structure-gate-v1",
        "unit_id": "unit-012-bab-2-sifat-universal-dan-kategori-koma",
