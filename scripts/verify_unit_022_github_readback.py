#!/usr/bin/env python3
"""Anonymously verify every path in the immutable Unit 022 GitHub commit."""
...
COMMIT = "46f2730ba4d0e8f197c52fefaf097b7a104df9a5"
REPOSITORY = "KokunoYumeto/metode-aljabar-jilid-1-id"
EXPECTED_PARENT = "92b0868078187d9a599878ea99144fb4006f55cd"
EXPECTED_PATH_COUNT = 49
OUTPUT = ROOT / "qa" / "PUBLICATION_GITHUB_UNIT_022_CONTENT_READBACK.json"
...
def main() -> int:
    ...
    if parent != EXPECTED_PARENT:
        raise RuntimeError(f"unexpected Unit 022 parent: {parent}")
