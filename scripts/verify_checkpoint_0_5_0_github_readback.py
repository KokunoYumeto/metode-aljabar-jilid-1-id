#!/usr/bin/env python3
"""Anonymously verify the immutable checkpoint 0.5.0 GitHub content commit."""
...
COMMIT = "1c3479a8fdf8c23c2f72789db2bbc969a4b9b639"
REPOSITORY = "KokunoYumeto/metode-aljabar-jilid-1-id"
EXPECTED_PARENT = "0da7f46721ed3cd9601c1ce09d8b38a700ab3064"
EXPECTED_PATH_COUNT = 7
OUTPUT = ROOT / "qa" / "PUBLICATION_GITHUB_CHECKPOINT_0.5.0_CONTENT_READBACK.json"
...
def main() -> int:
    ...
    if parent != EXPECTED_PARENT:
        raise RuntimeError(f"unexpected checkpoint parent: {parent}")
