#!/usr/bin/env python3
"""Anonymously verify every path in the 0.5.0 preservation/terminology commit."""
...
COMMIT = "3e27180c6d12ac9000f8880333a07e69a8771e19"
REPOSITORY = "KokunoYumeto/metode-aljabar-jilid-1-id"
EXPECTED_PARENT = "a6f9dcb7c9ad826be4ad85d48f7dfd154ab8689b"
EXPECTED_PATH_COUNT = 12
OUTPUT = ROOT / "qa" / "PUBLICATION_GITHUB_PRESERVATION_0.5.0_CONTENT_READBACK.json"
...
def main() -> int:
    ...
    if parent != EXPECTED_PARENT:
        raise RuntimeError(f"unexpected preservation parent: {parent}")
