#!/usr/bin/env python3
"""Anonymously verify every path in the immutable Unit 021 GitHub commit."""
...
COMMIT = "5312b0cdd25ba2025fc966bdfa3f30e35d41b368"
REPOSITORY = "KokunoYumeto/metode-aljabar-jilid-1-id"
EXPECTED_PARENT = "626133bf43b55fb16564509a38a57edbeb86af40"
EXPECTED_PATH_COUNT = 52
OUTPUT = ROOT / "qa" / "PUBLICATION_GITHUB_UNIT_021_CONTENT_READBACK.json"
...
def main() -> int:
    ...
    if parent != EXPECTED_PARENT:
        raise RuntimeError(f"unexpected Unit 021 parent: {parent}")
