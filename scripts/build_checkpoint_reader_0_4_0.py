#!/usr/bin/env python3
"""Build the reader-first 0.4.0 checkpoint PDF from admitted unit PDFs."""
...
OUTPUT = ROOT / "output" / "pdf" / "00-metode-aljabar-jilid-1-id-checkpoint-0.4.0-reader.pdf"
COVER = ROOT / "tmp" / "pdfs" / "checkpoint-0.4.0-cover.pdf"
...
UNITS = [
    ...
    ("Bab 2 - Fungtor dan Transformasi Natural (Bagian 2.2)", "unit-010-bab-2-fungtor-dan-transformasi-natural.pdf"),
    ("Bab 2 - Kategori Fungtor (Bagian 2.2)", "unit-011-bab-2-kategori-fungtor.pdf"),
    ("Bab 2 - Sifat Universal dan Kategori Koma (Bagian 2.4)", "unit-012-bab-2-sifat-universal-dan-kategori-koma.pdf"),
]
...
def make_cover(path: Path) -> None:
    ...
    c.drawString(42, height - 42, "CHECKPOINT PEMBACA 0.4.0")
    ...
    c.drawString(42, height - 125, "Karya asli: Wen-Wei Li  |  23 Agustus 2026")
    ...
    y2 = draw_wrapped(
        c,
        "Pendahuluan lengkap, Bab 1 lengkap, pengantar Bab 2, dan Bagian 2.1-2.4 "
        "lengkap dalam dua belas unit. Bagian 2.5 dan seluruh bagian sesudahnya belum disertakan.",
        52,
        y - 38,
        width - 104,
        REGULAR_FONT,
    ...
    c.drawString(42, 22, "Dua belas unit yang telah melewati pemeriksaan build, struktur, backend, dan visual semua halaman.")
    c.showPage()
    c.save()
...
def build(output: Path) -> None:
    ...
    writer.add_metadata(
        {
            "/Title": "Metode Aljabar, Jilid 1: Arsitektur Dasar - Edisi Bahasa Indonesia - Checkpoint 0.4.0",
            "/Author": "Wen-Wei Li",
            "/Subject": "Checkpoint parsial publik: pendahuluan, Bab 1, pengantar Bab 2, dan Bagian 2.1-2.4",
            "/Keywords": "aljabar, teori kategori, morfisme, fungtor, sifat universal, kategori koma, Bahasa Indonesia, checkpoint 0.4.0",
