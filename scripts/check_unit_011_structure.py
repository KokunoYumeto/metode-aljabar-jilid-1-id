...
#!/usr/bin/env python3
"""Fail-closed structural and mathematics-topology gate for O013 Unit 011.
...
def main() -> None:
    ...
    report = {
        "schema_version": "unit-011-structure-gate-v1",
        "unit_id": "unit-011-bab-2-kategori-fungtor",
