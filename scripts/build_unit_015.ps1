[CmdletBinding()]
param(
    [string]$OutputDirectory = "build/unit-015-replay"
)
...
$jobName = "unit-015-bab-2-contoh-keunikan-dan-ekuivalensi-adjoin"
$xelatexArguments = @(
    "-no-shell-escape",
...
[Environment]::SetEnvironmentVariable("SOURCE_DATE_EPOCH", "1787443200", "Process")
