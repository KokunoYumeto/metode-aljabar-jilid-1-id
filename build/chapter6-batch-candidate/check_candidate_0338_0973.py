...
CANDIDATE = Path(__file__).with_name("chapter6-lines-0338-0973-id.tex")
AUTHORITY_SHA256 = "c825f51dc19c254c89a7ede05723b62d6cd2b18cc6ac8c78d9ea00c3b8434e49"
SOURCE_SLICE_SHA256 = "4d8a21c4a8d2504ea00c352acd9e5d04ec1c4e6186dd0632b7f136971ce4a7fc"
CANDIDATE_SHA256 = "c3332fd7954513cc2a0c173c68b82cbd67591eda08efcf1de9d8b62fa19df999"
SOURCE_START = 338
SOURCE_END = 973
NEXT_CURSOR = r"\section{主理想环上的有限生成模}\label{sec:PID-module}"
...
def main() -> int:
    ...
    source_display = [skeleton(item) for item in display_math(source_text)]
    target_display = [skeleton(item) for item in display_math(candidate_text)]
    ...
    print(f"display_math={len(target_display)}")
